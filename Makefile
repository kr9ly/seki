...
release:
	...
	CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -trimpath -ldflags "-s -w" -o $(DIST)/seki-darwin-arm64 ./cmd/seki
	cd $(DIST) && sha256sum seki-linux-arm64 seki-linux-amd64 seki-darwin-arm64 > SHA256SUMS
